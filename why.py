...
# Favourites menu command
def show_favourites():
    messagebox.showinfo("Favourites", "⭐ Favourite contacts feature coming soon!")

# Blocked menu command
def show_blocked():
    messagebox.showinfo("Blocked", "🚫 Blocked contacts feature coming soon!")
